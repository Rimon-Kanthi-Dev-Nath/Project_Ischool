...
//Modal1 -->
	...
	<div class="about-top" id="about">
		<div class="container">
			...
			<div class="col-md-7 wthree-services-bottom-grids">
				<div class="wthree-services-left" data-aos="fade-down" data-aos-anchor-placement="top-bottom" data-aos-duration="3000" data-aos-delay="300">
					<img src="images/ab1.jpg" alt="">
				</div>
				<div class="wthree-services-right" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="3000" data-aos-delay="300">
	...
	<!-- //about -->
	<!--stats-->
	<div class="stats" id="stats" data-aos="zoom-in-up" data-aos-anchor-placement="top-bottom" data-aos-duration="3000" data-aos-delay="300">
		<div class="container">
					...
					<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
						...
						<div class="agile_contact_grid_right agileits_w3layouts_right1">
							...
							<p><a href="mailto:info@example.com"><?php echo $general_fetch['website_email1']; ?></a>
								<span><a href="mailto:info@example.com"><?php echo $general_fetch['website_email2']; ?></a></span>
							</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					...
					<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
						...
						<div class="agile_contact_grid_right agileits_w3layouts_right1">
							...
							<p><a href="mailto:info@example.com"><?php echo "Business Email"; ?></a>
								<span><a href="mailto:info@example.com"><?php echo "Email 2"; ?></a></span>
							</p>
						</div>
						<div class="clearfix"> </div>
					</div>
			...
			<div class="container">
				<div class="wthree_footer_grid_left">
					...
					<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
						<h4>Contact Us</h4>
						<ul>
							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com"><?php echo "Website "; ?></a></li>
